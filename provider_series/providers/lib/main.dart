...
class InnerCount with ChangeNotifier {
  int cvalue = 0;
...
class Counter with ChangeNotifier {
  int value = 0;
  InnerCount innerCount = InnerCount();
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // final watch = context.watch<Counter>();
    final select2 = context.select<Counter, int>((counterO) => counterO.value);
    final select3 =
        context.select<Counter, int>((counterO) => counterO.innerCount.cvalue);
    final select4 =
        context.select<Counter, InnerCount>((counterO) => counterO.innerCount);
